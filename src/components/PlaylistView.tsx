...
export function PlaylistView({ playlist, tracks, onToggleLike, onAddTrack, variant = 'playlist' }: PlaylistViewProps) {
    ...
    <div className="flex flex-col">
      ...
      <div className="px-2 md:px-6 pb-8">
        {filteredTracks.length > 0 ? (
          <TrackTable tracks={filteredTracks} onToggleLike={onToggleLike} />
        ) : filter.trim() ? (
